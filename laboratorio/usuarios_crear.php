...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password === '') {
        $errors[] = "La contrase\u{00F1}a es obligatoria.";
    }
...
<head>
    ...
    <link rel="stylesheet" href="styles/button.css?v=<?= filemtime(__DIR__ . '/styles/button.css') ?>">
    <style>
        :root {
            --white: #ffffff;
            --page-bg: #ffffff;
            ...
            <div class="admin-hero">
                ...
                <div class="hero-copy">
                    <span class="eyebrow">
                        ...
                        <span>Gestión de usuarios del módulo</span>
                    </span>
                    <h1>Crear Usuario</h1>
                    <p class="page-note">Crea un nuevo usuario para el módulo <?= lab_users_e($module['nombre']) ?> sin salir de la pantalla administrativa.</p>
