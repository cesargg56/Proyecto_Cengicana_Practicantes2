...
/*Extraer datos de MYSQL*/
	...
	i.nombre_ingenios
	 FROM cengi_cursos.asignaciones a 
	 INNER JOIN cengi_cursos.cursos c ON (a.cursos_id=c.id)
	 INNER JOIN cengi_cursos.participantes p ON (a.participantes_id=p.id)
