...
class ingenios{
	...
	public function consultar_visibles(){
		...
		$sql="SELECT id, nombre_ingenios FROM cengi_cursos.ingenios";
	...
	public function getCursoByNombre($nombre){
		$db = DataBase::getInstancia();
		$mysqli = $db->getConnection();
		$sql="SELECT id, nombre_ingenios FROM cengi_cursos.ingenios WHERE nombre_ingenios LIKE '%$nombre%' ORDER BY nombre_ingenios";
