...
/**
 * Clase para manejo de los cursos
 *
...
class cursos{
	...
	public function consultar_todos(){
		...
		$sql="SELECT
				  ...
				  cu.creado,
				  cu.actualizado
				FROM cengi_cursos.cursos cu
				INNER JOIN categorias_cursos ca ON (cu.categoria_curso_id=ca.id)
				INNER JOIN ingenios i ON (cu.ingenio_id=i.id) ORDER BY cu.nombre_cursos";
	...
	public function consultar_visibles(){
		...
		$sql="SELECT
				...
				FROM cengi_cursos.cursos cu
				INNER JOIN categorias_cursos ca ON (cu.categoria_curso_id=ca.id)
				INNER JOIN ingenios i ON (cu.ingenio_id=i.id) WHERE ca.estado_categorias_cursos<>0 ORDER BY nombre_cursos";
	...
	public function getCursoByNombre($nombre){
		...
		$sql="SELECT
				...
				FROM cengi_cursos.cursos cu
				INNER JOIN categorias_cursos ca ON (cu.categoria_curso_id=ca.id)
				INNER JOIN ingenios i ON (cu.ingenio_id=i.id) WHERE ca.estado_categorias_cursos<>0 AND cu.nombre_cursos LIKE '%$nombre%' ORDER BY nombre_cursos";
